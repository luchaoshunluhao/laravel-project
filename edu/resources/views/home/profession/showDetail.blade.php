...
<body>
    ...
    <div id="course-list">
        <div class="nav" id="NoShowIntroduct" style="display: block;">
            <a href="https://www.boxuegu.com/index.html">{{ $data ->pro_name }}</a><span> &gt; </span><span class="myClassName" style="margin-left:0px" href="/web/html/courseIntroductionPage.html?id=76&amp;courseType=0&amp;free=undefined">{{ $data ->pro_name }}</span>
        </div>
        ...
        <div class="bigpic">
            <div class="bigpic-title">
                ...
                <div class="bigpic-body"><span class="bigpic-body-title"><span class="bigpic-body-title-nav">微信小程序实战开发</span></span><span id="d_clip_button" class="shareCourse" data-clipboard-target="fe_text">分享课程，赚取学费<em>&gt;&gt;</em></span>
                    ...
                    <div class="bigpic-body-btn"><a href="/showOrder?id={{ $data -> id }}" class="gotengxun purchase">立即报名</a><a class="free-try-to-lean">免费试学</a></div>
                </div>
            </div>
        </div>
        <div id="introductBox">
