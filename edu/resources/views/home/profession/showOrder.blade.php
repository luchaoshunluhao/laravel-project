    ...
    <div class="main">
        ...
        <div class="main-table">
            ...
            <div class="tab clearfix">
                ...
                <div class="td2">即日起至{{ date('Y-m-d H:i', strtotime('+1 year')) }}</div>
            ...
            <!--支付宝的表单-->
            <form action="/alipay/alipayapi.php" name="pay" class="alipayform" method="post" target="_blank">
                <input type="hidden" name="WIDout_trade_no" value="{{ date('YmdHis') . rand(100000,999999) }}" id="out_trade_no">
                <input type="hidden" name="WIDsubject" value="在线教育专业购买：{{ $data -> pro_name }}">
                <input type="hidden" name="WIDtotal_fee" value="{{ $data -> price * 0.0001 }}">
                <input type="hidden" name="WIDbody" value="自购买之日起一年内有效">
