            ...
            <div id="public-class-live">
                ...
                <div style="width:110%;">
                    <ul class="public-class-live-content clearfix">
                        @foreach($live as $val)
                        <li>
                            <a style="cursor:pointer" href="{{ route('home_live') }}?id={{$val->id}}" target="_blank">
                                ...
                                <div class="public-class-live-detail">
                                    ...
                                    <div class="detailLiveInfo clearfix">
                                        <div class="detailLiveDate">最近直播：{{ date('Y/m/d H:i', $val -> begin_at) }}</div>
                                        <div class="detailLiving"><img src="/home/img/zhiboNoStart.png" alt=""><span class="noStart">{{ $val -> live_status }}</span></div>
                                    </div>
                                </div>
                            </a>
                        </li>
                ...
                <div id="log" style="width: 100%;">
                    <div id="content" class="content clearfix" style="width: 110%;">
                        ...
                        <div class="course clearfix">
                            <a href="/showDetail?id={{ $val->id }}" target="_blank">
                                ...
                                <div class="detail">
                                    ...
                                    <p class="info clearfix"><span><i>￥</i><span class="price">{{ $val->price * 0.0001 }}</span>
                                        ...
                                        </span><span class="stuCount"><img src="/home/img/studentCount.png" alt=""><span class="studentCou">{{ $val->viewcount }}</span></span>
                                    </p>
                                </div>
                            </a>
                        </div>
