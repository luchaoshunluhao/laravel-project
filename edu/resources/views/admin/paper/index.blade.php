...
<head>
    ...
    <script>DD_belatedPNG.fix('*');</script><![endif]--><title>试卷管理</title>
</head>
<body>
<nav class = "breadcrumb"><i class = "Hui-iconfont">&#xe67f;</i> 首页 <span class = "c-gray en">&gt;</span> 管理员管理 <span
            class = "c-gray en">&gt;</span> 试卷管理 <a class = "btn btn-success radius r"
    ...
    <table class = "table table-border table-bordered table-bg">
        ...
        @foreach($data as $val)
            <tr class = "text-c">
                ...
                <td>{{ $val -> rel_course -> course_name }}</td>
