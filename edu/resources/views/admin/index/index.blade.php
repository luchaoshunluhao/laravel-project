...
<head>
    ...
    <script type = "text/javascript" src = "/admin/lib/respond.min.js"></script><![endif]-->
    ...
    <script>DD_belatedPNG.fix('*');</script><![endif]--><title>H-ui.admin v3.1</title>
...
<header class = "navbar-wrapper">
    <div class = "navbar navbar-fixed-top">
        <div class = "container-fluid cl"><a class = "logo navbar-logo f-l mr-10 hidden-xs"
                    href = "/aboutHui.shtml">H-ui.admin</a> <a class = "logo navbar-logo-m f-l mr-10 visible-xs"
                    href = "/aboutHui.shtml">H-ui</a> <span class = "logo navbar-slogan f-l mr-10 hidden-xs">v3.1</span>
...
<aside class = "Hui-aside">
    <div class = "menu_dropdown bk_2">
        ...
        <dl id = "menu-article">
            @if($v -> pid == 0)
            <dt><i class = "Hui-iconfont">&#xe616;</i> {{ $v -> auth_name }}<i class = "Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
            </dt>
            @endif
            <dd>
                ...
                <ul>
                    @if( $v -> id == $c -> pid)
                    <li><a data-href = "article-list.html" data-title = "{{ $c -> auth_name }}" href = "javascript:void(0)">{{ $c -> auth_name }}</a></li>
                    @endif
                </ul>
                @endforeach
            </dd>
        ...
        @endforeach--}}
            <dl id = "menu-article">
                ...
                <dd>
                    <ul>
                        <li><a data-href = "{{ route('protype_index') }}" data-title = "专业管理" href = "javascript:void(0)">专业列表</a></li>
                        <li><a data-href = "{{ route('profession_index') }}" data-title = "专业管理" href = "javascript:void(0)">专业分类</a></li>
                    </ul>
                </dd>
            </dl>
        <dl id = "menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href = "{{ route('course_index') }}" data-title = "课程列表" href = "javascript:void(0)">课程列表</a></li>
                    <li><a data-href = "{{ route('lesson_index') }}" data-title = "点播列表" href = "javascript:void(0)">点播列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id = "menu-product">
            ...
            <dd>
                <ul>
                    <li><a data-href = "{{ route('paper_index') }}" data-title = "试卷列表" href = "javascript:void(0)">试卷列表</a>
                    </li>
                    <li><a data-href = "{{ route('question_index') }}" data-title = "试题列表" href = "javascript:void(0)">试题列表</a>
                    </li>
                </ul>
            </dd>
        </dl>
        <dl id = "menu-comments">
            ...
            <dd>
                <ul>
                    <li><a data-href = "{{ route('live_index') }}" data-title = "评论列表" href = "javascript:;">直播列表</a></li>
                    <li><a data-href = "{{ route('stream_index') }}" data-title = "意见反馈" href = "javascript:void(0)">流列表</a>
                    </li>
                </ul>
            </dd>
        </dl>
        ...
        <dl id = "menu-admin">
            ...
            <dd>
                <ul>
                    <li><a data-href = "{{ route('role_index') }}" data-title = "角色管理" href = "javascript:void(0)">角色管理</a></li>
                    <li><a data-href = "{{ route('auth_index') }}" data-title = "权限管理" href = "javascript:void(0)">权限管理</a>
                    </li>
    ...
    <div id = "Hui-tabNav" class = "Hui-tabNav hidden-xs">
        <div class = "Hui-tabNav-wp">
            <ul id = "min_title_list" class = "acrossTab cl">
                <li class = "active">
                    <span title = "我的桌面" data-href = "{{ route('welcome') }}">我的桌面</span> <em></em></li>
            </ul>
        </div>
