...
<head>
    ...
    <script>DD_belatedPNG.fix('*');</script><![endif]--><title>直播流管理</title>
</head>
<body>
<nav class = "breadcrumb"><i class = "Hui-iconfont">&#xe67f;</i> 首页 <span class = "c-gray en">&gt;</span> 管理员管理 <span
            class = "c-gray en">&gt;</span> 直播流管理 <a class = "btn btn-success radius r"
...
<div class = "page-container">
    ...
    <div class = "cl pd-5 bg-1 bk-gray mt-20">
        <span class = "l">
            ...
            <a href = "javascript:;" onclick = "stream_add('添加直播流', '{{ route('stream_add') }}', '', '420')" class = "btn btn-primary radius"><i class = "Hui-iconfont">&#xe600;</i> 添加直播流节点</a>
        </span>
        <span
